...
export const projectData = [
    {
        id: 1,
        title: 'Landing Page: Alabarda',
        description: 'Pagina de presentacion para una pagina web de E-Commerce sobre indumentaria formal.',
        links: {
            GitHub: 'https://github.com/MauroLozano/Alabarda',
