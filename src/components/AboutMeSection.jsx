        ...
        <section className={styles.aboutme__section}>
            ...
            <div className={styles['aboutme__content']}>
                <div className={styles['aboutme__info--container']}>
                    <p>Soy Mauro Lozano, un estudiante de Tecnicatura en Desarrollo de Software. Mi primer contacto con la programacion fue de pequeño. Pasaba horas enganchado frente a la pantalla intentando depurar mi codigo, pero curiosamente no estaba sufriendo, se sentía como un desafío</p>
